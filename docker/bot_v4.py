#!/usr/bin/env python3
"""Версия бота для поиска конкретных значений: сумма 1500 и номер 7 987 933 55 15."""
import os
import asyncio
import tempfile
import subprocess
...
class ReceiptChecker:
    ...
    def __init__(self):
        ...
        self.target_amount = self.validation_rules['target_amount']
        self.target_phone = self.validation_rules['target_phone']
        self.target_phone_formatted = self.validation_rules['target_phone_formatted']
